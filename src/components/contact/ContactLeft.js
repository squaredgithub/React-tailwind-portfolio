  ...
  return (
    <div className="w-full lgl:w-[35%] h-full  p-4 lgl:p-8 rounded-lg  flex flex-col gap-8 justify-center">
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-black">Francis Njuguna</h3>
        <p className="text-lg font-normal text-black-400">
          Full Stack Developer
        </p>
        <p className="text-base text-black-400 tracking-wide">
          Reach out to me for my professional web development services,
          or Send a message here.
        </p>
        <p className="text-base text-black-400 flex items-center gap-2">
