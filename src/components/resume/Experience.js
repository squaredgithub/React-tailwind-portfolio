      ...
      >
        <div>
          <div className="flex flex-col gap-2 md:gap-4">
            <p className="text-xs md:text-sm text-lightText tracking-[2px] md:tracking-[4px] hover:text-black">
              2022-Present
            </p>
            <div className="flex justify-center items-center text-center">
               <Title des="Experience" />
             </div>
          </div>
          <div className="mt-10 md:mt-14 w-full border-l-[4px] md:border-l-[6px] border-l-black flex flex-col gap-8 md:gap-10">
            <ResumeCard
